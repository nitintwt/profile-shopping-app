...
function AllCartProducts() {
  ...
  const handleDeleteFromCart = async (productId)=>{
    try {
     const deleteProduct = await axios.delete(`${import.meta.env.VITE_AWS_API}/api/v1/users/deleteProductFromCart?productId=${productId}&userId=${cookies?.userData?._id}`)
